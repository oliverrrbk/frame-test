...
const newFunc = `const getDynamicRoofImage = (material, feature) => {
    ...
    if (matKey.includes('skiffer')) matGroup = 'skiffer';
    ...
    const map = {
        ...
        'tegl_pitch_flat': '/images/roof_pitch_flat.png', 
        ...
        'beton_pitch_flat': '/images/roof_pitch_flat.png',
        ...
        'skiffer_pitch_flat': '/images/roof_pitch_flat.png',
        'skiffer_pitch_pitched': '/images/roof_skiffer_pitch_pitched_1781083020910.png',
        'skiffer_type_saddle': '/images/roof_skiffer_pitch_pitched_1781083020910.png',
        'skiffer_type_valm': '/images/roof_skiffer_type_valm_1781083030802.png',
...
console.log('Successfully added all roof materials to dynamic logic!');
