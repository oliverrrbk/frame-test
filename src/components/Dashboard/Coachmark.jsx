        ...
        const sync = () => {
            ...
            if (el && bubble) {
                ...
                if (arrow) {
                    ...
                    arrow.style.left = `${Math.round(aLeft)}px`;
                    if (place === 'top') {
                        arrow.style.top = 'auto'; arrow.style.bottom = '-8px';
                        arrow.style.borderLeft = 'none'; arrow.style.borderTop = 'none';
                        arrow.style.borderRight = '1px solid rgba(0,0,0,.07)';
                        arrow.style.borderBottom = '1px solid rgba(0,0,0,.07)';
                    } else {
                        arrow.style.bottom = 'auto'; arrow.style.top = '-8px';
                        arrow.style.borderRight = 'none'; arrow.style.borderBottom = 'none';
                        arrow.style.borderLeft = '1px solid rgba(0,0,0,.07)';
                        arrow.style.borderTop = '1px solid rgba(0,0,0,.07)';
                    }
                }
            }
