                                ...
                                <div className="glass-panel-tab" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                    ...
                                    {!['worker', 'apprentice', 'guest'].includes(simulatedRole || profile?.role) && subcontractorBreakdown.length > 0 && (
                                        <div style={{ background: '#faf5ff', border: '1px solid #e9d5ff', borderRadius: '16px', padding: '16px 18px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                            ...
                                            {!isMobile && <p style={{ margin: 0, fontSize: '0.8rem', color: '#7c3aed', lineHeight: 1.5 }}>Åbn en underleverandør for at afstemme en (del)faktura — vælg periode, indtast timeløn og se præcis de timer der ligger bag.</p>}
                                            {subcontractorBreakdown.map(b => (
                                                <div key={b.id} style={{ background: '#fff', border: '1px solid #e9d5ff', borderRadius: '12px', padding: '12px 14px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px' }}>
                                                    <div style={{ minWidth: 0 }}>
                                                        ...
                                                        <div style={{ fontSize: '0.82rem', color: '#7c3aed', fontWeight: 700 }}>{b.hours.toFixed(2)}{isMobile ? ' t' : ' timer i alt på sagen'}</div>
                                                    </div>
                                        ...
                                        <div onClick={() => setReconcileSub(null)} style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(15, 23, 42, 0.5)', backdropFilter: 'blur(4px)', WebkitBackdropFilter: 'blur(4px)', zIndex: 100001, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px' }}>
                                            <div onClick={(e) => e.stopPropagation()} style={{ width: '100%', maxWidth: '560px', maxHeight: '90vh', overflowY: 'auto', background: '#fff', borderRadius: '24px', boxShadow: '0 24px 48px -12px rgba(0,0,0,0.25)', border: '1px solid #e2e8f0' }}>
                                                ...
                                                <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: '18px' }}>
                                                    ...
                                                    {!isMobile && <p style={{ margin: 0, fontSize: '0.75rem', color: '#94a3b8', lineHeight: 1.5 }}>Kun til afstemning — påvirker ikke løn, timebudget eller fakturaer.</p>}
                                                </div>
                                            </div>
                                        </div>
                                    );
