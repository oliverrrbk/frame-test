...
import { ChevronDown, Calendar, Plus, Clock, TrendingUp, AlertTriangle, Edit2, Trash2, X, Save, FileText } from 'lucide-react';
...
export default function WorkerTimesheet({ leadsData, myProfile, simulatedRole }) {
    ...
    const handleDeleteEntry = async (entry) => {
        ...
        if (entry.leadId === 'internal') {
            ...
            const newRawData = { ...myProfile.raw_data, time_entries: currentEntries };
