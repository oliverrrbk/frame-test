...
const TermsContent = ({ onOpenDpa }) => (
    <div className="text-slate-700 dark:text-slate-300 leading-relaxed font-sans text-sm md:text-base">
        ...
        <p className="mb-4 text-justify">6.2. <strong>Abonnementsmodel (grundplan + pr. bruger):</strong> Abonnementet består af en fast månedlig grundplan pr. virksomhed samt et tillæg pr. aktiv ekstra bruger efter brugerens rolle. Grundplanen findes i to niveauer: en enkeltbruger-plan (én bruger, uden timeregistrering) og en holdplan, der inkluderer tre brugere samt timeregistrering. Yderligere brugere afregnes pr. sæde efter rolle, idet kontoradgang (fx projektleder, bogholder eller ekstra mester) samt feltadgang som henholdsvis svend og lærling prissættes hver for sig. Prisen pr. ekstra bruger nedsættes automatisk efter virksomhedens samlede antal brugere — første gang fra og med den 11. bruger og igen fra og med den 51. bruger, uanset rolle. De til enhver tid gældende priser og rolledefinitioner fremgår af Bison Companys prisside.</p>
        ...
        <p className="mb-4 text-justify">6.4. <strong>Store hold:</strong> Prismodellen er gennemsigtig uanset virksomhedens størrelse. Der er ingen særskilt entrepriseaftale — prisen pr. ekstra bruger følger de trin, der er beskrevet i pkt. 6.2, uanset hvor mange brugere virksomheden har.</p>
                ...
                <div className="flex flex-col gap-12 max-w-[1440px] mx-auto min-h-[160px]">
                    <div className="flex flex-col md:flex-row justify-between items-start gap-12 w-full">
                        ...
                        <div className="flex flex-col max-w-[320px]">
                            ...
                            <p className="mb-6 leading-relaxed">Et simpelt system, der virker.<br />Lavet i samarbejde med tømrere — til tømrere.</p>
